...
class HRVProcessor:
   ...
   # def __init__(self, db_path='g:/My Drive/Phoenix/DataBasesDev/artemis_hrv.db'):
    def __init__(self, db_path='c:/smakryko/myHealthData/DataBasesDev/artemis_hrvDEV.db'):
...
def main():
    ...
    processor = process_activities_folder('C:/smakryko/myHealthData/HealtDataSystemAnalysis/TestFitFiles/Garmin')
