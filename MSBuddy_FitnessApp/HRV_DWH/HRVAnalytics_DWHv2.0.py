...
class HRVAnalytics:
    ...
    def __init__(self, db_path: str = "Mercury_DWH-HRV.db"):
    ...
    def get_daily_hrv_dataframe(self, days_back: int = 30, source_name: str = "F3b Monitor+HRV") -> pd.DataFrame:
        """
    ...
    def _get_personal_baselines(self, source_name: str = "F3b Monitor+HRV") -> Dict[str, float]:
        """
    ...
    def _calculate_personalized_recovery_score(self, rmssd: float, sdnn: float, pnn50: float,
                                             ...
                                             source_name: str = "F3b Monitor+HRV") -> float:
        """
    ...
    def analyze_hrv_trends(self, days_back: int = 30, source_name: str = "F3b Monitor+HRV",
