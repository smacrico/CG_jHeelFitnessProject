...
class RunningAnalysis:
    def __init__(self, db_path):
        self.db_path = r'g:/My Drive/Genesis_dev/DataBasesDev/RunningAnalysis.db'  # Use consistent path
...
def main():
    # Database path
    db_path = 'g:/My Drive/Genesis_dev/DataBasesDev/RunningAnalysis.db'

    # Create analysis object
    analysis = RunningAnalysis('g:/My Drive/Genesis_dev/DataBasesDev/RunningAnalysis.db')
