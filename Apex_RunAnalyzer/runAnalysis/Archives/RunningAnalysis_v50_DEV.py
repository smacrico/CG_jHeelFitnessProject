...
# Ensure consistent database path usage
# db_path = 'c:/smakryko/myHealthData/DataBasesDev/ApexDEV.db'
# db_path = r'g:/My Drive/Phoenix/DataBasesDev/ApexDEV.db   '  # Use raw string for Windows path

class RunningAnalysis:
    def __init__(self, db_path):
        self.db_path = r'c:/smakryko/myHealthData/DataBasesDev/ApexDEV.db'  # Use consistent path
    ...
    def load_training_data(self):
        ...
        try:
            ...
            conn = sqlite3.connect(r'c:/smakryko/myHealthData/DataBasesDev/ApexDEV.db')
            query = """
...
def main():
    ...
    analysis = RunningAnalysis('c:/smakryko/myHealthData/DataBasesDev/ApexDEV.db')
